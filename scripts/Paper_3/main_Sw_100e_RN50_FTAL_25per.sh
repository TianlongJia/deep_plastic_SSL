...
srun python tools/run_distributed_engines.py \
  ...
  config.CHECKPOINT.DIR="/scratch/tjian/PythonProject/deep_plastic_SSL/checkpoints/train_weights/Self_train_tiles_224/pretrain_25per/RN50_Sw_100e_FTAL/vissl" \

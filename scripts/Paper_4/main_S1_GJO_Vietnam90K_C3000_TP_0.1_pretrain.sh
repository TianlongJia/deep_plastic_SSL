...
srun python tools/run_distributed_engines.py \
  ...
  config.CHECKPOINT.DIR="/scratch/tjian/PythonProject/deep_plastic_SSL/checkpoints/train_weights/Paper_4/Vitenam/Self_train_GJO_Vit_90K/C3000_TP_0.1/vissl" \
